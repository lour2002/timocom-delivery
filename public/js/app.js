...
__webpack_require__(/*! ./dtsel */ "./resources/js/dtsel.js"); // import Quill from 'quill';
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (document.getElementById("task_individual_days")) {
    var task_individual_days = new dtsel.DTS('#task_individual_days', {
      direction: 'TOP',
  ...
  if (document.getElementById("task_period_start")) {
    var task_period_start = new dtsel.DTS('#task_period_start', {
      direction: 'TOP',
      dateFormat: "dd.mm.yyyy",
      showTime: false,
      timeFormat: "HH:MM:SS"
  ...
  if (document.getElementById("task_period_stop")) {
    var task_period_stop = new dtsel.DTS('#task_period_stop', {
      direction: 'TOP',
      dateFormat: "dd.mm.yyyy",
      showTime: false,
      timeFormat: "HH:MM:SS"
...
window.settingsFormEdit = function () {
  return {
    ...
    trigger: _defineProperty({}, '@click', function click(url) {
      this.showModal = true;
    })
  };
};
